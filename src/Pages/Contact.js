            ...
            <div className="slider-container">
                <Slider {...settings}>
                    {Technology.map((r) => (
                        <div key={r.id}>
                            <Card>
                                <Card.Img className="cardImg" variant="top" src={r.img} alt='' style={{ height: "350px", alignContent: "center" }} />
                                <Card.Body>
                                    <Card.Title>{r.title}</Card.Title>
                                    <Card.Text className='card.author'>{r.Author}</Card.Text>
                                    <Card.Text className='card.text'>{r.description}</Card.Text>
            ...
            <div className="slider-container">
                <Slider {...settings}>
                    {Biography.map((r) => (
                        <div key={r.id}>
                            <Card>
                                <Card.Img className="cardImg" variant="top" src={r.img} alt='' style={{ height: "300px", alignContent: "center" }} />
                                <Card.Body>
                                    <Card.Title>{r.title}</Card.Title>
                                    <Card.Text className='card.author'>{r.Author}</Card.Text>
                                    <Card.Text className='card.text'>{r.description}</Card.Text>
